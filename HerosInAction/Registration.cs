...
public class AvengersProfile
{
    ...
    public static async Task CreateUsernameAsync()
    {
        ...
        // Jarvis föreslår en roll baserat på svar
        ...
        // Frågar efter e-postadress för notiser och mission updates
        string email;
        do
        {
        ...
        // Nollställ poäng i MissionManagement för den nya hjälten
